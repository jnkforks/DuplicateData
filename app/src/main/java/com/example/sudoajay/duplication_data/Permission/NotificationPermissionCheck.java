...
//
//    public NotificationPermissionCheck( Activity activity,After_MainTransferFIle after_mainTransferFIle){
//        this.activity =activity;
//        this.after_mainTransferFIle =after_mainTransferFIle;
//    }
//    public NotificationPermissionCheck( Activity activity,Show_Duplicate_File show_duplicate_file){
//        this.activity =activity;
