package com.sudoajay.duplication_data.Custom_Dialog;
...
public class CustomDialogForBackgroundTimer extends DialogFragment implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    private NiceSpinner repeatedlySpinner;
...
//        setupChooseImageView(chooseSpinner.getSelectedIndex());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.okButton:
                ...
                if (repeatedlySpinner.getSelectedIndex() != 0) {
    ...
    private void SaveToDatabase() {
        ...
        if (backgroundTimerDataBase.check_For_Empty()) {
            backgroundTimerDataBase.FillIt(repeatedlySpinner.getSelectedIndex(), get_Repeat(), getSelectedEndlesslyDate);

        } else {
            backgroundTimerDataBase.UpdateTheTable("1", repeatedlySpinner.getSelectedIndex(), get_Repeat(), getSelectedEndlesslyDate);
        }
